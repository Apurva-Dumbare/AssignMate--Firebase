...
const Sem_3 = (props) => {
  ...
  const PdfData = async (props) => {
      ...
      try {
          ...
          const snapshot = await get(child(ref(db), `Semester_data/Semester 3`));
          if (snapshot.exists()) {
                            ...
                            <div className="subject_container fade-in Background">
                                <div className="subject1 color_class top_Margin">
                                    <div className='sub_subject1 '>
                                        ...
                                        <div className='Subject_info'>
                                            <Link to="/Sem_3/Data Structures"><p className="glow_animation">{ImgFile[0].sub_name}</p></Link>
                                ...
                                <div className="subject1">
                                    <div className='sub_subject1'>
                                        ...
                                        <div className='Subject_info'>
                                            <Link to="/Sem_3/Database Management -II" ><p> {ImgFile[1].sub_name}</p></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="subject1">
                                    <div className='sub_subject1'>
                                        ...
                                        <div className='Subject_info'>
                                            <Link to="/Sem_3/Computer Networks" ><p>  {ImgFile[2].sub_name}  </p></Link>
                                ...
                                <div className="subject1">
                                    <div className='sub_subject1'>
                                        ...
                                        <div className='Subject_info'>
                                            ...
                                            <Link to="/Sem_3/Language Communication -I(English)"><p> {ImgFile[3].sub_name}  </p></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="subject1">
                                    ...
                                    <div className='sub_subject1'>
                                        ...
                                        <div className='Subject_info '>
                                            <Link to="/Sem_3/Environmental Awareness -I"> <p> {ImgFile[4].sub_name}</p></Link>
                                        </div>
                                    </div>
                                ...
                                <div className="subject1">
                                    <div className='sub_subject1'>
                                        ...
                                        <div className='Subject_info'>
                                            ...
                                            <Link to="/sem_3/Activity"><p> {ImgFile[5].sub_name}  </p></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>

...
const Sem_2 = (props) => {
  ...
  const PdfData = async (props) => {
      ...
      try {
          ...
          const snapshot = await get(child(ref(db), `Semester_data/Semester 2`));
          if (snapshot.exists()) {
                            ...
                            <div className="subject_container fade-in Background">
                                <div className="subject1 color_class top_Margin">
                                    <div className='sub_subject1 '>
                                        ...
                                        <div className='Subject_info'>
                                            <Link to="/sem_2/Computer organization"><p className="glow_animation">{ImgFile[0].sub_name}</p></Link>
                                ...
                                <div className="subject1">
                                    <div className='sub_subject1'>
                                        ...
                                        <div className='Subject_info'>
                                            <Link to="/AdvCProgramming" ><p> {ImgFile[1].sub_name}</p></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="subject1">
                                    <div className='sub_subject1'>
                                        ...
                                        <div className='Subject_info'>
                                            <Link to="/sem_2/operating system concepts" ><p>  {ImgFile[2].sub_name}  </p></Link>
                                ...
                                <div className="subject1">
                                    <div className='sub_subject1'>
                                        ...
                                        <div className='Subject_info'>
                                            ...
                                            <Link to="/sem_2/Database Management Systems - I"><p> {ImgFile[3].sub_name}  </p></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="subject1">
                                    ...
                                    <div className='sub_subject1'>
                                        ...
                                        <div className='Subject_info '>
                                            <Link to="/sem_2/Activity"> <p> {ImgFile[4].sub_name}</p></Link>
                                        </div>
                                    </div>
